...
const Menu:React.FC<IMenuProps> = ({handleToggleForm}) => {
  return (
    <header className="  max-w-7xl w-full  mr-5 ml-4 mt-6 mb-8 h-40 bg-[#F9FAFB] rounded-lg gap-2 ">
         <div className="h-full pt-6  pb-5 max-w-lg mx-auto  flex flex-col items-center justify-between gap-6">
             ...
             <div className="w-48 h-10 flex bg-[#7F56D9] text-center rounded-md justify-center items-center gap-3" onClick={handleToggleForm}>
             <Image
              src="/plus-circle.svg"
              alt="plus"
              width={20}
