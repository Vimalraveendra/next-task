...
const NavigationList = () => {
  return (
    <div className=" w-full max-w-7xl  mr-5 ml-4 mt-6 rounded-lg border-solid border border-[#D0D5DD] overflow-hidden">
     <ul className="border-solid border-b border-[#EAECF0] gap-1  bg-white " >
            <li
                className="flex items-center justify-between py-4 px-6 "
                draggable="true"
            >
  
                <div className=" w-10 h-10 py-2.5 px-2.5 flex items-center">
                            <Image
                                src="/move.svg"
                                alt="plus"
                                width={20}
                ...
                <div className="border-solid border border-[#D0D5DD]  rounded-lg shadow-sm ">
